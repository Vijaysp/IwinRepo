...
public class UserTeam
{
	...
	/**
	 * @param player5 the player5 to set
	 */
	...
	/**
	 * @param player6 the player6 to set
	 */
	...
	/**
	 * @param player7 the player7 to set
	 */
	...
	/**
	 * @param player8 the player8 to set
	 */
	...
	/**
	 * @param player9 the player9 to set
	 */
	...
	/**
	 * @param player10 the player10 to set
	 */
	...
	/**
	 * @param player11 the player11 to set
	 */
